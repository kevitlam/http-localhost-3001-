        ...
        <div className="text-center mb-16">
          ...
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 p-6 bg-white rounded-lg max-w-md mx-auto">
            ...
            <div className="text-center sm:text-left">
              ...
              <a href="mailto:hello@micheal.com" className="text-xl sm:text-2xl font-bold text-stone-900 hover:text-accent-600 transition-colors break-all">
                hello@micheal.com
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-stone-400">
                ...
                <a href="mailto:hello@micheal.com" className="hover:text-white transition-colors">hello@micheal.com</a></p>
